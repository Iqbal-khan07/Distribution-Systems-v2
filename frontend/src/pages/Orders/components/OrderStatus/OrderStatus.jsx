        ...
        <Card raised className={classes.card}>
            ...
            <CardContent className={classes.root}>
                <div className={classes.statusHolder}>
                    ...
                    <Typography variant="h4"  display={"inline"} style={{marginLeft: 10}}>
                        Delivered
                    </Typography>
                </div>
                <hr />
                <div>
                    <Typography variant="h4" display={"inline"} style={{marginRight: 30}} >
                        Pending
                    </Typography>
                ...
                <hr />
                <div>
                    <Typography variant="h4" display={"inline"} style={{marginRight: 75}}>
                        Credit
                    </Typography>
